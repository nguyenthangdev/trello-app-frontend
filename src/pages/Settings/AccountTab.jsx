...
import { selectCurrentUser, updateUserAPI } from '~/redux/user/userSlide'
...
function AccountTab() {
  ...
  const uploadAvatar = (e) => {
    ...
    toast.promise(
      ...
      // Lưu ý, dù có lỗi hoặc thành công thì cũng phải clear giá trị của file input, nếu không thì sẽ không thể chọn cùng 1 file liên tiếp đc.
      e.target.value = ''
    })
  }
