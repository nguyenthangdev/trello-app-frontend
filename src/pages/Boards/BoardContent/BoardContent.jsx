...
const BoardContent = ({
  ...
  // Lưu data cuối cùng sau khi kết thúc hết việc kéo thả
  ...
  // Function chung xử lý việc cập nhật state trong trường hơp di chuyển Card giữa các Column khác nhau.
