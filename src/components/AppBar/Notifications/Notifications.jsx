...
import {
  ...
  addNotification
} from '~/redux/notifications/notificatonsSlide'
...
function Notifications() {
  ...
  useEffect(() => {
    ...
    // Tạo 1 cái function xử lý khi nhận đc sự kiện real-time
    const onReceiveNewInvitation = (invitation) => {
      // Nếu thằng user đang đăng nhập hiện tại mà chúng ta lưu trong redux chính là thằng invitee trong bản ghi boardInvitation
